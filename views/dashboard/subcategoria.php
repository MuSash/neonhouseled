...
$subcategorias=$subcat->obtenerSubcategorias();
$categorias=$subcat->obtenerCategorias();
  ...
  if (isset($_POST['publicar'])) {
      ...
      $subcat->guardarSubcategoria($datos);
    }
  ...
  <div class="row">
    ...
    <div id="main" class="p-0 container-fluid main">
      ...
      <div class="p-4 p-lg-5  main__container">
        <div class="row m-0 mb-5"><h2>Sub-Categorias</h2></div>
          <div class="row">
            <div class="pt-4 col-12 col-xl-12 last__publications">
              ...
              ?>
              <form action="<?=URL?>subcategoria" method="POST" name="publicarForm" id="publicarForm" enctype="multipart/form-data">
                <div class="form-row">
                  <div class="form-group col-md-12">
                    <label for="inputEmail4">Nombre de sub-categoria</label>
                    <input required type="text" class="form-control" id="nombre" name="nombre" placeholder="">
                  </div>
                </div>
                  <div class="form-group col-md-6">
                    <label for="inputPassword4">Categoria</label>
                    <select required id="id_cat" name="id_cat" class="form-control">
                    ...
                    if (!empty($subcategorias)) {
                        foreach ($subcategorias as $r) {
                          echo "<tr>";
                            echo "<td>".$r['id']."</td>";
                            echo "<td>".$r['nombre']."</td>";
                            echo "<td><a href='".URL."editsub?id=".$r['id']."&id_subcat=".$r['id_cat']."'".">Editar</a> | <a href='".URL."elisub?id=".$r['id']."'>Eliminar</a></td>";
                          echo "</tr>";
                        }
                    }
                  ?>
