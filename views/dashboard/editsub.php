  ...
  if(isset($_GET['id'])){    
   $subcategoria=$subcat->obtenerSubcategoria($_GET['id']);
 } 
  ...
  if (isset($_POST['actualizar'])) {
      ...
      $subcat->actualizarSubcategoria($datos);
      header("Location:".URL."subcategoria");
  } else {
    ...
    <div id="main" class="p-0 container-fluid main">
      <header class="pr-3 pl-3 pr-md-3 pl-md-3 pr-lg-5 pl-lg-5 d-flex justify-content-end align-items-center header">
        <div class="w-100 text-sm-left text-md-center">
          <h1 class="m-0  side__nav--title d-none"><?php echo "VERAMENDIS"; ?></h1>
        </div>
      ...
      <div class="p-4 p-lg-5  main__container">
        <div class="row m-0 mb-5"><h2>Edite Subcategoria</h2></div>
          <div class="row">
            <div class="pt-4 col-12 col-xl-12 last__publications">
              ...
              ?>
              <form action="<?=URL?>editsub?id=<?php echo $_GET['id']?>" method="POST" name="publicarForm" id="publicarForm" enctype="multipart/form-data">
                <div class="form-row">
                  <div class="form-group col-md-12">
                    <label for="inputEmail4">Nombre de Subcategoria</label>
