...
class DB extends PDO {
	...
	private $database = 'pollo3';//ghxumdmy_pollo
	private $username = 'root';//ghxumdmy_veramendischicken
	private $password = '';//veramendischicken
	private $pdo;
	private $sQuery;
	...
	private function Init($query,$parameters = "") {
		if (!$this->bConnected) { $this->connection(); }
		try {
